...
resource "aws_iam_policy" "put_stori_thumbnail_images" {
  name        = "put_stori_thumbnail_images"
  description = "This policy grants put objects on the stori-thumbnail-images-dllr bucket"
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "arn:aws:s3:::stori-thumbnail-images-dllr/*"
            ]
        }
    ]
  })
...
resource "aws_iam_policy" "get_stori_thumbnail_images" {
  name        = "get_stori_thumbnail_images"
  description = "This policy grants get objects on the stori-thumbnail-images-dllr bucket"
